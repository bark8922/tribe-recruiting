...
**Visuals:** 17
**Tables referenced:** Calendar, LastRefreshedDate, Metrics, client, job
**Measures used:** 3
...
### 1. Job Creation Date  _(HierarchySlicer1458836712039)_
...
- `job` → `user_hiring_manager`, `job_title`, `date_created`
...
### 6.   Job Created Date  _(slicer)_
- `job` → `date_created`

### 7. _(untitled)_  _(card)_
- `LastRefreshedDate` → `LastRefreshedDate`

### 8. _(untitled)_  _(slicer)_
- `job` → `job_title`, `date_created`

### 9. _(untitled)_  _(textbox)_
- _no refs extracted_
...
### 13. _(untitled)_  _(shape)_
- _no refs extracted_

### 14. _(untitled)_  _(slicer)_
- `job` → `job_recruiter`, `job_title`, `date_created`

### 15. _(untitled)_  _(?)_
- _no refs extracted_

### 16. Jobs Details  _(tableEx)_
- `job` → `job_id`, `job_title`, `job_recruiter`, `user_hiring_manager`, `email_hiring_manager`, `date_created`, `date_first_hired`, `External Recruiter?`
- `client` → `client_name`
- `Metrics` → `% Viewed to Contacted`, `% Contacted to Reacted`, `% Reacted to Actual Screen`

### 17. _(untitled)_  _(slicer)_
- `job` → `date_first_hired`, `job_title`, `date_created`
...
- `email_hiring_manager` (table: job)
- `job_id` (table: job)
