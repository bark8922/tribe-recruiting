...
def run_transformations(con: duckdb.DuckDBPyConnection):
    ...
    con.execute("""
        ...
        SELECT
            ...
            j.recruiter_responsible AS job_recruiter,
            j.sourcer_responsible AS job_sourcer,
            j.atsID AS ats_id,
    ...
    con.execute("""
        ...
        SELECT
            ...
            e.who_created_event AS who_created_event,
            NULL::VARCHAR AS who_created_event_first,
            e.who_event_created_for AS who_event_created_for,
    ...
    con.execute("""
        ...
        SELECT
            ...
            c.sourcer AS candidate_sourcer,
